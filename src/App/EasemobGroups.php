...
trait EasemobGroups
{
     ...
     * @throws EasemobException
     */
    public function groupCreate($group_name, $group_description, $owner_user, $members_users = [], $is_public = true, $max_user = 200, $is_approval = true)
    {
